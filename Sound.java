...
public class Sound {
    ...
    public Sound() {
        try {
            ...
            // soundURL[7] = new File(Utils.joinPath(Constants.SOUNDS_PATH,
            // "swingweapon.wav")).toURI().toURL();
            soundURL[8] = new File(Utils.joinPath(Constants.SOUNDS_PATH, "levelup.wav")).toURI().toURL();
